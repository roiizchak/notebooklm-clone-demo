...
-- supabase/migrations/. See docs/superpowers/specs/2026-05-11-deep-research-design.md.
...
-- B-COR-02 pattern: at most one in-flight job per notebook. Concurrent
-- POSTs collide at DB layer; the second caller catches 23505 -> 409.
...
-- RLS: owner-only access, matching the per-action pattern used by
-- study_materials / notes / audio_overviews in migration 008.
